    ...
    <div className="min-h-screen bg-cream-50">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" id="firstName" name="firstName" value={formData.firstName} onChange={handleInputChange} required className="input-field" placeholder="John" />
                    </div>
                    <div>
                      ...
                      <input type="text" id="lastName" name="lastName" value={formData.lastName} onChange={handleInputChange} required className="input-field" placeholder="Smith" />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} required className="input-field" placeholder="john@example.com" />
                    </div>
                    <div>
                      <label htmlFor="phone" className="block text-sm font-medium text-forest-700 mb-2">
                        Phone
                      </label>
                      <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleInputChange} className="input-field" placeholder="(704) 929-3289" />
                    </div>
                  </div>

                  <div>
                    <label htmlFor="propertyInterest" className="block text-sm font-medium text-forest-700 mb-2">
                      Property Interest <span className="text-saddle-600">*</span>
                    </label>
                    <select id="propertyInterest" name="propertyInterest" value={formData.propertyInterest} onChange={handleInputChange} required className="select-field">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-forest-700 mb-3">Preferred Contact Method</label>
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="preferredContact" value="email" checked={formData.preferredContact === "email"} onChange={() => handleRadioChange("email")} className="w-4 h-4 text-forest-600 border-forest-300 focus:ring-forest-500" />
                        <span className="text-forest-700">Email</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="preferredContact" value="phone" checked={formData.preferredContact === "phone"} onChange={() => handleRadioChange("phone")} className="w-4 h-4 text-forest-600 border-forest-300 focus:ring-forest-500" />
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" value={formData.message} onChange={handleInputChange} required rows={5} className="input-field resize-none" placeholder="Tell us about your equestrian property needs..." />
                  </div>

                  <button type="submit" disabled={formStatus === "submitting"} className="btn-primary w-full flex items-center justify-center gap-2 py-4 text-lg disabled:opacity-70 disabled:cursor-not-allowed">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+17049293289" className="text-forest-900 font-semibold hover:text-saddle-600 transition-colors">(704) 929-3289</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-forest-100 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@carolinahorsefarmrealty.com" className="text-forest-900 font-semibold hover:text-saddle-600 transition-colors break-all">info@carolinahorsefarmrealty.com</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-forest-100 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-forest-900 font-semibold">123 Equestrian Way<br />Suite 200<br />Charlotte, NC 28277</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-forest-100 flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-white rounded-xl shadow-lg border border-cream-200 overflow-hidden">
                <div className="aspect-[4/3] bg-gradient-to-br from-forest-100 to-forest-200 flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-forest-500 text-sm text-center mt-2">Interactive map with directions to our office</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-forest-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white rounded-lg shadow-sm border border-cream-200 overflow-hidden">
                <button onClick={() => toggleFaq(index)} className="w-full flex items-center justify-between p-5 text-left hover:bg-cream-50 transition-colors">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-forest-800 to-forest-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="tel:+17049293289" className="inline-flex items-center gap-3 btn-secondary text-lg px-8 py-4">
